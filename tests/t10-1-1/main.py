...
from src.data_processing import (Ngram, randomized_ngram, sequence_loader_MNIST, test_loader_MNIST, train_loader_MNIST)
...
torch.manual_seed(525365891)
np.random.seed(358228)
