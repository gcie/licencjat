...
from src.data_processing import (randomized_ngram,
...
torch.manual_seed(467023047)
np.random.seed(1052413214)
...
sequence_loader = sequence_loader_MNIST(ngram, num_samples=2000, sequence_length=30)
